...
public class TransferMudControllerOBM implements Initializable {
    ...
    Double[] con = new Double[9];
    String dateGlob ; String wellGlob; String locGlob;Double totMudAll;Double amountMudTrans;
    ObservableList<RowTableOBM> tableGlob = FXCollections.observableArrayList();
        ...
        if ((chooseWell.getValue()==null)) {
            ...
            if (NumberUtils.isCreatable(amountMud.getText()))
            {
                ...
                else
                {
                    ...
                    con[8]=app.calc_conc(tableGlob, 9)*amountMudTrans;
                    close();
                }
            }
            else
    ...
    public void loadLocation(String loc,String well,ObservableList<RowTableOBM> table2,String date){
        OilBaseMudController app = new OilBaseMudController();
        try {
